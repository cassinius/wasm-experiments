...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || "fft_wasm.wast";
  var wasmBinaryFile = Module['wasmBinaryFile'] || "fft_wasm.wasm";
  var asmjsCodeFile = Module['asmjsCodeFile'] || "fft_wasm.asm.js";
...
STATICTOP = STATIC_BASE + 23584;
  /* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
  

memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "fft_wasm.html.mem" : null;




var STATIC_BUMP = 23584;
