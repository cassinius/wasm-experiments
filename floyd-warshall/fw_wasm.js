...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'fw_wasm.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'fw_wasm.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'fw_wasm.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "fw_wasm.html.mem" : null;
