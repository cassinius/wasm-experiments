...
pub fn 
mult_loop_no_simd(x: [u32; 4], y: [u32; 4], mut res_arr: Vec<[u32; 4]>, n: usize) -> Vec<[u32; 4]> {
 ...
 */
pub fn mult_loop_simd(x: v128, y: v128, mut res_arr: Vec<v128>, n: usize) -> Vec<v128> {
	for i in 0..n {
		res_arr[i] = i32x4_mul(x, y);
	}	
	return res_arr;
}
