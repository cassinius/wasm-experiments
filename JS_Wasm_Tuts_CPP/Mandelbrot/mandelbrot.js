  ...
  if (endPtr - idx > 16 && u8Array.subarray && UTF8Decoder) {
    ...
    while (idx < endPtr) {
      ...
      if ((u0 & 0xF0) == 0xE0) {
        ...
        if ((u0 & 0xF8) != 0xF0) warnOnce('Invalid UTF-8 leading byte 0x' + u0.toString(16) + ' encountered when deserializing a UTF-8 string on the asm.js/dom heap to a JS string!');
...
function stringToUTF8Array(str, outU8Array, outIdx, maxBytesToWrite) {
  ...
  for (var i = 0; i < str.length; ++i) {
    ...
    if (u <= 0x7F) {
      ...
      if (u >= 0x200000) warnOnce('Invalid Unicode code point 0x' + u.toString(16) + ' encountered when serializing a JS string to an UTF-8 string on the asm.js/dom heap! (Valid unicode code points should be in range 0-0x1FFFFF).');
...
var wasmBinaryFile = 'mandelbrot.dom';
...
Module['asm'] = function(global, env, providedBuffer) {
  ...
  assert(exports, 'binaryen setup failed (no dom support?)');
  return exports;
};
